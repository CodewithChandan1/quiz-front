...
import ViewMaterialuser from './students/materials/ViewMaterial';
function App() {
  return (
    <div className="App">
      <Router>
        ...
        <Route path="/admin"element={<Adminmaster/>}>
          ...
          <Route path="/admin/add_material" element={<AddMaterial/>}/>
          <Route path="/admin/manage_material" element={<ManageMaterial/>}/>
